...
export class ApiService {
  ...
  getUserTimeout() {
    return this.http.get('http://localhost:8080/generic/users').pipe(
      delay(5000), // Resposta após 5 segundos
      timeout(2500), // Timeout se não tiver resposta em 2.5 segundos
